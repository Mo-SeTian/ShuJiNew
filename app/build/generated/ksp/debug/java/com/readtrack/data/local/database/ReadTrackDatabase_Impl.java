  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(10) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `books` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `title` TEXT NOT NULL, `author` TEXT, `publisher` TEXT, `description` TEXT, `progressType` TEXT NOT NULL, `totalPages` REAL NOT NULL, `currentPage` REAL NOT NULL, `totalChapters` INTEGER, `currentChapter` INTEGER NOT NULL, `coverPath` TEXT, `status` TEXT NOT NULL, `bookType` TEXT NOT NULL, `rating` REAL, `createdAt` INTEGER NOT NULL, `updatedAt` INTEGER NOT NULL, `lastReadAt` INTEGER)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '081577d0e90e781a9e4a20a5ba8943f2')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsBooks.put("bookType", new TableInfo.Column("bookType", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _foreignKeysReadingRecords.add(new TableInfo.ForeignKey("books", "SET NULL", "NO ACTION", Arrays.asList("bookId"), Arrays.asList("id")));
    ...
    }, "081577d0e90e781a9e4a20a5ba8943f2", "b3d46c0597e62f4e0dc3a0b03e6c73bf");
