  ...
  public BookDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfBookEntity = new EntityInsertionAdapter<BookEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `books` (`id`,`title`,`author`,`publisher`,`description`,`progressType`,`totalPages`,`currentPage`,`totalChapters`,`currentChapter`,`coverPath`,`status`,`bookType`,`rating`,`createdAt`,`updatedAt`,`lastReadAt`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        final String _tmp_2 = __converters.fromBookType(entity.getBookType());
        statement.bindString(13, _tmp_2);
        if (entity.getRating() == null) {
          statement.bindNull(14);
        } else {
          statement.bindDouble(14, entity.getRating());
        }
        ...
        if (entity.getLastReadAt() == null) {
          ...
          statement.bindLong(17, entity.getLastReadAt());
        }
      }
    };
    ...
    this.__updateAdapterOfBookEntity = new EntityDeletionOrUpdateAdapter<BookEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `books` SET `id` = ?,`title` = ?,`author` = ?,`publisher` = ?,`description` = ?,`progressType` = ?,`totalPages` = ?,`currentPage` = ?,`totalChapters` = ?,`currentChapter` = ?,`coverPath` = ?,`status` = ?,`bookType` = ?,`rating` = ?,`createdAt` = ?,`updatedAt` = ?,`lastReadAt` = ? WHERE `id` = ?";
      }
      ...
      public List<BookEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final BookType _tmpBookType;
            final String _tmp_2;
            _tmp_2 = _cursor.getString(_cursorIndexOfBookType);
            _tmpBookType = __converters.toBookType(_tmp_2);
            ...
            _item = new BookEntity(_tmpId,_tmpTitle,_tmpAuthor,_tmpPublisher,_tmpDescription,_tmpProgressType,_tmpTotalPages,_tmpCurrentPage,_tmpTotalChapters,_tmpCurrentChapter,_tmpCoverPath,_tmpStatus,_tmpBookType,_tmpRating,_tmpCreatedAt,_tmpUpdatedAt,_tmpLastReadAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public List<BookEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final BookType _tmpBookType;
            final String _tmp_3;
            _tmp_3 = _cursor.getString(_cursorIndexOfBookType);
            _tmpBookType = __converters.toBookType(_tmp_3);
            final Float _tmpRating;
            if (_cursor.isNull(_cursorIndexOfRating)) {
              _tmpRating = null;
            } else {
      ...
      public BookEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new BookEntity(_tmpId,_tmpTitle,_tmpAuthor,_tmpPublisher,_tmpDescription,_tmpProgressType,_tmpTotalPages,_tmpCurrentPage,_tmpTotalChapters,_tmpCurrentChapter,_tmpCoverPath,_tmpStatus,_tmpBookType,_tmpRating,_tmpCreatedAt,_tmpUpdatedAt,_tmpLastReadAt);
          } else {
            _result = null;
          }
          return _result;
