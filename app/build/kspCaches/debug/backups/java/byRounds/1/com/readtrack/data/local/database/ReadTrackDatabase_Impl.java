  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(5) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `reading_records` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `bookId` INTEGER NOT NULL, `pagesRead` REAL NOT NULL, `fromPage` REAL NOT NULL, `toPage` REAL NOT NULL, `date` INTEGER NOT NULL, `note` TEXT, FOREIGN KEY(`bookId`) REFERENCES `books`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE )");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '0f34ccbaf84f58debfeb2a317512ff0e')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsReadingRecords = new HashMap<String, TableInfo.Column>(7);
    ...
    }, "0f34ccbaf84f58debfeb2a317512ff0e", "24b5b8a3e99e181936182b4cd76fd4d9");
