...
object BadgeCatalog {
    ...
    val ALL: List<Badge> = listOf(
        ...
        Badge("reader_first", BadgeCategory.QUANTITY, BadgeTier.BRONZE,
            ...
            quote = "每一段旅程都始于翻开第一页"),
        Badge("reader_3", BadgeCategory.QUANTITY, BadgeTier.BRONZE,
            icon = "📗", title = "初窥门径",
            description = "累计读完 3 本书，阅读的乐趣渐渐浮现",
            threshold = 3, progressKey = PROGRESS_FINISHED, unit = "本",
            quote = "三本过后，你已初尝阅读的甘甜"),
        Badge("reader_5", BadgeCategory.QUANTITY, BadgeTier.BRONZE,
            icon = "📘", title = "书虫初醒",
            description = "累计读完 5 本书，你已经比大多数人更爱阅读",
            threshold = 5, progressKey = PROGRESS_FINISHED, unit = "本",
            quote = "五本书的距离，就是从路人到读者的距离"),
        ...
        Badge("reader_20", BadgeCategory.QUANTITY, BadgeTier.SILVER,
            icon = "📦", title = "小有成就",
            description = "累计读完 20 本书，书架已初具规模",
            threshold = 20, progressKey = PROGRESS_FINISHED, unit = "本",
            quote = "二十本书，二十级台阶。你正稳步向上"),
        ...
        Badge("streak_14", BadgeCategory.STREAK, BadgeTier.SILVER,
            icon = "📅", title = "双周坚持",
            description = "连续 14 天（两周）每天阅读，习惯已经扎根",
            threshold = 14, progressKey = PROGRESS_STREAK, unit = "天",
            quote = "两周不辍，21 天法则的近邻。你离习惯只差一步"),
        ...
        Badge("streak_60", BadgeCategory.STREAK, BadgeTier.GOLD,
            icon = "🗓️", title = "双月之旅",
            description = "连续 60 天（两个月）每天阅读，阅读如呼吸般自然",
            threshold = 60, progressKey = PROGRESS_STREAK, unit = "天",
            quote = "六十个日夜，书页翻动的声音已成生活的背景音"),
        ...
        // === 页数（6） ===
        Badge("pages_500", BadgeCategory.PAGES, BadgeTier.BRONZE,
            icon = "📃", title = "五百页之始",
            description = "累计阅读 500 页，相当于 1~2 本中等厚度的书",
            threshold = 500, progressKey = PROGRESS_TOTAL_PAGES, unit = "页",
            quote = "五百页，不多不少，正好是一个开始"),
        ...
        Badge("pages_5k", BadgeCategory.PAGES, BadgeTier.SILVER,
            icon = "📰", title = "五千页行者",
            description = "累计阅读 5,000 页，相当于 15~20 本书的厚度",
            threshold = 5000, progressKey = PROGRESS_TOTAL_PAGES, unit = "页",
            quote = "五千页，是量变到质变的分界线"),
        ...
        Badge("pages_50k", BadgeCategory.PAGES, BadgeTier.PLATINUM,
            icon = "📒", title = "五万页旅人",
            description = "累计阅读 50,000 页，可以装满一个小书架",
            threshold = 50000, progressKey = PROGRESS_TOTAL_PAGES, unit = "页",
            quote = "五万页，一字一句，皆是光阴的见证"),
        ...
        // === 章节（4） ===
        Badge("chapters_100", BadgeCategory.CHAPTERS, BadgeTier.BRONZE,
            icon = "🔖", title = "百章入门",
            description = "累计阅读 100 章，追更的快乐才刚刚开始",
            threshold = 100, progressKey = PROGRESS_TOTAL_CHAPTERS, unit = "章",
            quote = "一百章，是网络文学的基本单位"),
        ...
        Badge("chapters_1000", BadgeCategory.CHAPTERS, BadgeTier.GOLD,
            icon = "📋", title = "千章旅人",
            description = "累计阅读 1,000 章，你已是追更界的中流砥柱",
            threshold = 1000, progressKey = PROGRESS_TOTAL_CHAPTERS, unit = "章",
            quote = "一千章，足够看完一部完整的长篇史诗"),
